...
elseif(WIN32)
  set(TOOLCHAIN_DIR "C:/SiliconLabs/SimplicityStudio/v5_2/developer/toolchains/gnu_arm/10.3_2021.10/bin/")
elseif(APPLE)
...
elseif(WIN32)
  set(POST_BUILD_EXE "C:/SiliconLabs/SimplicityStudio/v5_2/developer/adapter_packs/commander/commander.exe")
elseif(APPLE)
  set(POST_BUILD_EXE "")
else()
  set(POST_BUILD_EXE "")
...
elseif(WIN32)
  set(NINJA_RUNTIME_PATH "C:/SiliconLabs/SimplicityStudio/v5_2/developer/adapter_packs/ninja/ninja.exe")
elseif(APPLE)
